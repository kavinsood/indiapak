      ...
      <section id="carousel" className="py-10">
        <div className="flex min-h-0 flex-col gap-y-8">
          <BlurFade delay={BLUR_FADE_DELAY * 6}>
            <h2 className="text-xl font-bold text-center">Look at the war (carousel)</h2>
          </BlurFade>
